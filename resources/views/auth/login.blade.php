    ...
    <div class="row justify-content-center ">
        <div class="col-md-7 ">
            <div class="ms_card card ">
                <div class="card-header ms_card_header pl-5 pt-4"><h5>Fai il Login</h5></div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input ms_input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary ms-button">
                                    {{ __('Login') }}
                                </button>

                                @if (Route::has('password.request'))
                                    <a class="btn btn-link ms_a" href="{{ route('password.request') }}">
